...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/estiloFoto.css">
</head>
<body>
      ...
      <div class="row justify-content-center align-items-center" id="login-row">
        <div class="col-md-6" id="login-column">
          <div id="login-box"  class="col-md-12 bg-light text-dark">
            ...
            <div class="form-group">
              <label for="foto" class="text-dark">Falla Detectada :</label>
              <input type="text" class="form-control" name="foto" id="foto" placeholder="Ingrese la Foto">
            </div>
