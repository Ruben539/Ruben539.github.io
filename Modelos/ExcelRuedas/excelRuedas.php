	...
	<tbody>
		...
		if(isset($_SESSION['consulta'])){
			if($_SESSION['consulta'] > 0){
				...
				$sql = "SELECT r.id_ruedas,r.modelo,r.nro_vehiculo,r.color,r.pieza,r.falla_detectada,r.usuario,r.sector,r.estado
				from ruedas r  where estatus = 1  AND id_ruedas = '$id_ruedas' ";
			}else{
				$sql = "SELECT r.id_ruedas,r.fecha_add,r.modelo,r.nro_vehiculo,r.color,r.pieza,r.falla_detectada,r.usuario,r.sector,r.estado
