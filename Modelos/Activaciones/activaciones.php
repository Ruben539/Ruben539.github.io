...
headerAdmin($data);
getModals('modalActivaciones', $data);
?>
...
<main class="app-content">
  <div class="app-title">
    <div>
      ...
      <h1><i class="fa fa-server" aria-hidden="true"></i> Motos Activadas - Inspección y Control
     ...
     <ul class="app-breadcrumb breadcrumb">
         <li class="breadcrumb-item"><a href="<?= base_url(); ?>/excelActivacion"><i class="fa fa-download" style="font-size: 20px;"></i>
      </a></li>
      <li class="breadcrumb-item"><a href="<?= base_url(); ?>/activaciones"><i class="fa fa-refresh" style="font-size: 20px;"></i>
      </a></li>
  </ul>
</div>
<div class="container">
                    ...
                    <tbody>
                        ...
                        while ($ver = mysqli_fetch_row($resultado)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class = "btn btn-outline-info" data-toggle="modal" data-target="#modalEditar" onclick="editarDatosAC('<?php echo $datos ?>')"><i class="fa fa-edit" aria-hidden="true"></i></button>
                                </td>
                            </tr>
                        <?php } ?>                       
                    </tbody>        
...
<?php footerAdmin($data); ?>
 <script src="<?php echo media(); ?>/js/Probado/activacionDatos.js"></script>