		...
		<tbody>
            ...
            if(isset($_SESSION['consulta'])){
                if($_SESSION['consulta'] > 0){
                    ...
                    $sql = "SELECT id_herreria,modelo,nro_vehiculo,color,pieza,falla_detectada,sector,estado,usuario
                    from herreria where estatus = 1  AND id_herreria = '$id_herreria' ";
                }else{
                    $sql = "SELECT id_herreria,fecha_add,modelo,nro_vehiculo,color,pieza,falla_detectada,usuario,sector,estado
