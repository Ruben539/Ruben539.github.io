<div class="modal fade" id="modalDeposito" tabindex="-1" role="dialog"  aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-body" id="formDeposito">
        <form action="">
        ...
        <div class="form-group">
          ...
          <input type="text" name="origen" id="origen" class="form-control input-sm">
        </div>
        <input type="hidden" name="sector" id="sector" value="<?php echo "TALLER LEVANTE" ?>">
      ...
      <div class="tile-footer">
        <button type="button" class="btn btn-primary" id="btnNuevoDep"><i class="fa fa-fw fa-lg fa-check-circle"></i>Guardar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="<?= base_url(); ?>/deposito"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
      </div>
      </form>
      </div>
    </div>
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog"  aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-body" id="formDeposito">
        <form action="">
        <input type="hidden" id="id_deposito">
        <div class="form-group">
          <label for="modelo">Modelo :</label>
        ...
        <div class="form-group">
          <label for="origen">Procedencia :</label>
          <input type="text" name="origenu" id="origenu" class="form-control input-sm">
        </div>
        <input type="hidden" name="usuariou" id="usuariou" value="<?php echo $_SESSION['user']; ?>">
      <div class="tile-footer">
        <button type="button" class="btn btn-primary" id="btnEditarDep"><i class="fa fa-fw fa-lg fa-check-circle"></i>Actualizar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="<?= base_url(); ?>/deposito"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
      </div>
      </form>
      </div>
    </div>
