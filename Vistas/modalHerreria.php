<div class="modal fade" id="modalHerreria" tabindex="-1" role="dialog"  aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-body" id="formHerreria">
        <form action="">
        <div class="form-group">
          <label for="modelo">Modelo :</label>
          <input type="text" name="modelo" id="modelo" class="form-control input-sm" autofocus>
        </div>
         <div class="form-group">
         ...
         <div class="form-group">
          ...
          <select class="form-control" id="pieza" name="pieza" required>
                ...
                <option value="Soporte de Burrito de Arranque">Soporte de Burrito de Arranque</option>
                <option value="Soporte de Resorte">Soporte de Resorte</option>
                <option value="Soporte de Amotiguador Delantero">Soporte de Amotiguador Delantero</option>
                <option value="Soporte de Amotiguador Trasero">Soporte de Amotiguador Trasero</option>
                <option value="Soporte de Tapa Costado">Soporte de Tapa Costado</option>
                <option value="Soporte de Amortiguador Trasero">Soporte de Amortiguador Trasero</option>
                <option value="Soporte de Amortiguador Trasero">Soporte de Guarda Cadena</option>
      ...
      <div class="tile-footer">
        <button type="button" class="btn btn-primary" id="btnNuevoH"><i class="fa fa-fw fa-lg fa-check-circle"></i>Guardar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="<?= base_url(); ?>/herreria"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
      </div>
      </form>
      </div>
    </div>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="">
        <input type="hidden" id="id_herreria">
        <div class="form-group">
          <label for="modelo">Modelo :</label>
       ...
       <input type="hidden" name="usuariou" id="usuariou" value="<?php echo $_SESSION['user']; ?>" class="form-control input-sm">
      <div class="tile-footer">
        <button type="button" class="btn btn-primary" id="btnEditarH"><i class="fa fa-fw fa-lg fa-check-circle"></i>Actualizar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="<?= base_url(); ?>/herreria"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
      </div>
      </form>
      </div>
    </div>
