<div class="modal fade" id="modalPintura" tabindex="-1" role="dialog"  aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-body" id="formPintura">
        <form action="">
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input name="falla_detectada" id="falla_detectada" class="form-control input-sm">
        </div>
      ...
      <div class="tile-footer">
        <button type="button" class="btn btn-primary" id="btnNuevoP"><i class="fa fa-fw fa-lg fa-check-circle"></i>Guardar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="<?= base_url(); ?>/pintura"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
      </div>
      </form>
      </div>
    </div>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="">
        <input type="hidden" id="id_pintura">
        <div class="form-group">
          <label for="modelo">Modelo :</label>
      ...
      <div class="tile-footer">
        <button type="button" class="btn btn-primary" id="btnEditarP"><i class="fa fa-fw fa-lg fa-check-circle"></i>Actualizar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="<?= base_url(); ?>/pintura"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
      </div>
      </form>
      </div>
    </div>
