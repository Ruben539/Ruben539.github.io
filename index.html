...
<body>
    <div id="login">
        <h3 class="text-center  display-4">División Industrial</h3>
                    ...
                    <div id="login-box" class="col-md-12  bg-light text-dark">
                        <form id="formLogin" class="form" action="" method="post">
                            ...
                            <div class="form-group">
                                <label for="usuario" class="text-dark"><b>Usuario :</b></label><br>
                            ...
                            <div class="form-group text-center">                                
                                <input type="submit" name="submit" class="btnok  btn-lg btn-block" value="Ingresar">
                            </div>                            
                        </form>
                    </div>
                </div>
